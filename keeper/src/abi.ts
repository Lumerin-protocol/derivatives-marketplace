/**
 * Minimal ABI for the PerpsSimple contract.
 * Contains only the functions and events used by the keeper.
 * Source: contracts/abi/abi.ts (generated via wagmi)
 */
...
/**
 * Chainlink AggregatorV3Interface — used for the ETH/USD price feed.
 */
