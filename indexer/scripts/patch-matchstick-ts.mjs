 ...
 *
 * Perps emits struct-bearing events (e.g. the PortfolioMarginEngine /
 * options stack) and uint256-heavy params across the wider local stack, so
 * the tuple/bigint encoding fix is needed for the integration harness to
 * capture and replay those logs. Until upstream lands the fix, this script
 * rewrites both sides of the matchstick-ts wire format to encode tuples as
 * JSON arrays.
 *
